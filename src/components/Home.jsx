    ...
    return (
        <div className="w-full flex flex-col md:flex-row justify-between items-center h-[60vh]">
            <div className="md:w-1/2 px-4 md:px-0">
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-green-600">
                ...
                <Link to="/recipes">
                    <button className="bg-green-600 hover:bg-green-700 text-white py-3 px-6 rounded-lg shadow-md transition duration-200">
                        Get Started &nbsp; &#8594;
                    </button>
                </Link>
            </div>
